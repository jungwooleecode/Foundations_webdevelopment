...
workshops_data= {
    1 : {
        'date': '2022-05-20 14:30:00', 'name': 'Hip-hop choreography', 'teacher':'Honey J', 'price': 15.99, 'fixed_spots': 30, 'available_spots': 0, 'picture_url':'https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/lia-1498857451.jpg', 'video_url':'https://www.youtube.com/embed/WnSyWk9sjY0?autoplay=1&mute=1'
    },
    2 : {
    ...
    3 : {
        'date': '2022-06-03 16:00:00', 'name': 'Poppin choreography', 'teacher':'Noze', 'price': 10.99, 'fixed_spots': 30, 'available_spots': 0, 'picture_url':'https://i.ytimg.com/vi/eGrvoHIobNc/maxresdefault.jpg', 'video_url':'https://www.youtube.com/embed/r-waF2SXNbI?autoplay=1&mute=1'
    },
    4 : {
    ...
    6 : {
        'date': '2022-07-05 14:30:00', 'name': 'Heels choreography', 'teacher':'Aiki', 'price': 13.99, 'fixed_spots': 30, 'available_spots': 0, 'picture_url':'https://tmilly.com/wp-content/uploads/2018/03/Thumbnail-Tims-YouTube-1200x675.jpg', 'video_url':'https://www.youtube.com/embed/WnSyWk9sjY0?autoplay=1&mute=1'
    },
    7 : {
    ...
    9 : {
        'date': '2022-08-10 15:00:00', 'name': 'K-pop choreography', 'teacher':'Rian', 'price': 14.99, 'fixed_spots': 30, 'available_spots': 0, 'picture_url':'https://i.ytimg.com/vi/LVzEm9vO-hM/maxresdefault.jpg', 'video_url':'https://www.youtube.com/embed/8mMGGFGYgYA?autoplay=1&mute=1'
    },
    10 : {
    ...
    12 : {
        'date': '2022-09-01 15:00:00', 'name': 'Poppin choreography', 'teacher':'Lia Kim', 'price': 18.99, 'fixed_spots': 30, 'available_spots': 0, 'picture_url':'../static/images/workshop.png', 'video_url':'https://www.youtube.com/embed/8mMGGFGYgYA?autoplay=1&mute=1'
    },
    13 : {
